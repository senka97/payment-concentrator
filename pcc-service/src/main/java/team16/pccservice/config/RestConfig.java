package team16.pccservice.config;
...
public class RestConfig {
    ...
    public RestTemplate restTemplate() {
        ...
        return new RestTemplate(new HttpComponentsClientHttpRequestFactory(
                httpClient("PKCS12", "pcc-service.p12", "password", "pcc-service",
    ...
    public HttpClient httpClient(String keystoreType, String keystore, String keystorePassword, String alias,
        ...
        try {
            ...
            ClassPathResource resource1 = new ClassPathResource("pcc-service.p12");
